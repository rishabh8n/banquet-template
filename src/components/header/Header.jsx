    ...
    <>
      <div className="header">
        <div className="nav">
          <ul role="list">
            <li>
              <a className="clr-neutral-800 fw-500" href="">
                Home
              </a>
            </li>
            <li>
        ...
        <div className="logo fs-700 clr-accent-500">
          <svg
            version="1.0"
...
-297 -1z"
        ...
        <div className="contact-info">
          <div className="contact-item">
            <h6 className="fs-400">Address</h6>
            <p className="fs-100">
              GTB Nagar, <br /> Delhi
            </p>
          </div>
          <div className="contact-item">
            <h6 className="fs-400">Phone</h6>
            <p className="fs-100">9832654578</p>
          </div>
          <div className="contact-item">
            <h6 className="fs-400">Timing</h6>
            <p className="fs-100">10am-8pm</p>
          </div>
        </div>
        <button className="menu" onClick={() => setShowMenu((prev) => !prev)}>
          <div className="hamburger">
            <div className="top bg-neutral-800"></div>
            <div className="bottom  bg-neutral-800"></div>
          </div>
        </button>
      </div>
      {showMenu && (
        <div className="sidebar">
          <div className="nav">
            <ul role="list">
              <li>
                <a className="clr-neutral-100 fs-700 fw-500" href="">
                  Home
                </a>
              </li>
              <li>
